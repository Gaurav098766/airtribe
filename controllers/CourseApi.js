...
exports.create = async(req,res)=>{
    try {
        const {instructor_id, title, description, max_seats,start_date} = req.body;

        let data = 'INSERT INTO courses (instructor_id, title, description, max_seats,start_date) VALUES ($1, $2, $3, $4, $5) RETURNING *';
...
exports.update = async (req, res, next) => {
    try {
        ...
        let query = 'SELECT * FROM courses WHERE course_id = $1 AND instructor_id = $2';
        ...
        query = `UPDATE courses SET ${updateFields.join(', ')} WHERE course_id = $${paramCount} AND instructor_id = $${paramCount + 1} RETURNING *`;
...
exports.register = async(req,res)=>{
    try {
        ...
        let query = 'INSERT INTO leads (course_id, name, email, phone_number, linkedin_profile, status) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *' 
        let values =  [course_id, name, email, phone_number, linkedin_profile, 'Waitlist'];
